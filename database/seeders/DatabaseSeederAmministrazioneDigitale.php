...
class DatabaseSeederAmministrazioneDigitale extends Seeder
{
    ...
    private function generateExams($courseId) {
        GenerateExamBlock::generateBlock($courseId, 1, 12,
        ...
        GenerateExamBlock::generateBlock($courseId, 2, 6, [
